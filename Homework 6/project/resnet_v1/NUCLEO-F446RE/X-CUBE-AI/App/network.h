...
#define STAI_NETWORK_ORIGIN_MODEL_NAME         "resnet_v1_quant"
#define STAI_NETWORK_ORIGIN_MODEL_SIGNATURE    "0x638ae93fd58da5b5a71f8a546c45af7d"

/*  Generated model name and signature  */
#define STAI_NETWORK_MODEL_NAME                "network"
#define STAI_NETWORK_MODEL_SIGNATURE           (0x29800a4a039bff96)
...
#define STAI_NETWORK_MACC_NUM            (12541060)
...
#define STAI_NETWORK_ACTIVATIONS_SIZE              (43424)
#define STAI_NETWORK_ACTIVATIONS_SIZE_BYTES        (43424)
...
#define STAI_NETWORK_ACTIVATION_1_SIZE       (43424)
#define STAI_NETWORK_ACTIVATION_1_SIZE_BYTES (43424)
#define STAI_NETWORK_ACTIVATION_1_ALIGNMENT  4
/*  Macros to declare weights buffers characteristics  */

#define STAI_NETWORK_WEIGHTS_NUM                  (20)
#define STAI_NETWORK_WEIGHTS_SIZE                  (78744)
#define STAI_NETWORK_WEIGHTS_SIZE_BYTES            (78744)
#define STAI_NETWORK_WEIGHTS_ALIGNMENTS \
  { 4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4}
#define STAI_NETWORK_WEIGHTS_SIZES \
  { 432,64,2304,64,2304,64,512,128,4608,128,9216,128,18432,256,36864,256,2048,256,640,40}
#define STAI_NETWORK_WEIGHTS_NUM        (20)
...
#define STAI_NETWORK_WEIGHT_7_SIZE        (512)
#define STAI_NETWORK_WEIGHT_7_SIZE_BYTES  (512)
...
#define STAI_NETWORK_WEIGHT_9_SIZE        (4608)
#define STAI_NETWORK_WEIGHT_9_SIZE_BYTES  (4608)
...
#define STAI_NETWORK_WEIGHT_11_SIZE        (9216)
#define STAI_NETWORK_WEIGHT_11_SIZE_BYTES  (9216)
...
#define STAI_NETWORK_WEIGHT_13_SIZE        (18432)
#define STAI_NETWORK_WEIGHT_13_SIZE_BYTES  (18432)
...
#define STAI_NETWORK_WEIGHT_15_SIZE        (36864)
#define STAI_NETWORK_WEIGHT_15_SIZE_BYTES  (36864)
...
#define STAI_NETWORK_WEIGHT_19_SIZE        (640)
#define STAI_NETWORK_WEIGHT_19_SIZE_BYTES  (640)
#define STAI_NETWORK_WEIGHT_20_FLAGS       ((STAI_FLAG_PREALLOCATED))
#define STAI_NETWORK_WEIGHT_20_SIZE        (40)
#define STAI_NETWORK_WEIGHT_20_SIZE_BYTES  (40)
