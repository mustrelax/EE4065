...
#define STAI_NETWORK_ORIGIN_MODEL_NAME         "mobilenet_v1_quant"
#define STAI_NETWORK_ORIGIN_MODEL_SIGNATURE    "0xb6696d41992d73688b38079560ab0338"

/*  Generated model name and signature  */
#define STAI_NETWORK_MODEL_NAME                "network"
#define STAI_NETWORK_MODEL_SIGNATURE           (0xfb71d94498d92041)
...
#define STAI_NETWORK_NODES_NUM           (31)

/*  Macro to declare number macc for generated network model  */
#define STAI_NETWORK_MACC_NUM            (844004)
...
#define STAI_NETWORK_WEIGHTS_SIZE                  (221144)
#define STAI_NETWORK_WEIGHTS_SIZE_BYTES            (221144)
...
#define STAI_NETWORK_WEIGHTS_SIZES \
  { 216,32,72,32,128,64,144,64,512,128,288,128,1024,128,288,128,2048,256,576,256,4096,256,576,256,8192,512,1152,512,16384,512,1152,512,16384,512,1152,512,16384,512,1152,512,16384,512,1152,512,16384,512,1152,512,32768,1024,2304,1024,65536,1024,2560,40}
#define STAI_NETWORK_WEIGHTS_NUM        (56)
...
#define STAI_NETWORK_WEIGHT_2_SIZE        (32)
#define STAI_NETWORK_WEIGHT_2_SIZE_BYTES  (32)
#define STAI_NETWORK_WEIGHT_3_FLAGS       ((STAI_FLAG_PREALLOCATED))
#define STAI_NETWORK_WEIGHT_3_SIZE        (72)
#define STAI_NETWORK_WEIGHT_3_SIZE_BYTES  (72)
...
#define STAI_NETWORK_WEIGHT_5_SIZE        (128)
#define STAI_NETWORK_WEIGHT_5_SIZE_BYTES  (128)
...
#define STAI_NETWORK_WEIGHT_7_SIZE        (144)
#define STAI_NETWORK_WEIGHT_7_SIZE_BYTES  (144)
...
#define STAI_NETWORK_WEIGHT_9_SIZE        (512)
#define STAI_NETWORK_WEIGHT_9_SIZE_BYTES  (512)
...
#define STAI_NETWORK_WEIGHT_13_SIZE        (1024)
#define STAI_NETWORK_WEIGHT_13_SIZE_BYTES  (1024)
...
#define STAI_NETWORK_WEIGHT_15_SIZE        (288)
#define STAI_NETWORK_WEIGHT_15_SIZE_BYTES  (288)
...
#define STAI_NETWORK_WEIGHT_17_SIZE        (2048)
#define STAI_NETWORK_WEIGHT_17_SIZE_BYTES  (2048)
...
#define STAI_NETWORK_WEIGHT_21_SIZE        (4096)
#define STAI_NETWORK_WEIGHT_21_SIZE_BYTES  (4096)
...
#define STAI_NETWORK_WEIGHT_45_SIZE        (16384)
#define STAI_NETWORK_WEIGHT_45_SIZE_BYTES  (16384)
...
#define STAI_NETWORK_WEIGHT_47_SIZE        (1152)
#define STAI_NETWORK_WEIGHT_47_SIZE_BYTES  (1152)
#define STAI_NETWORK_WEIGHT_48_FLAGS       ((STAI_FLAG_PREALLOCATED))
#define STAI_NETWORK_WEIGHT_48_SIZE        (512)
#define STAI_NETWORK_WEIGHT_48_SIZE_BYTES  (512)
#define STAI_NETWORK_WEIGHT_49_FLAGS       ((STAI_FLAG_PREALLOCATED))
#define STAI_NETWORK_WEIGHT_49_SIZE        (32768)
#define STAI_NETWORK_WEIGHT_49_SIZE_BYTES  (32768)
#define STAI_NETWORK_WEIGHT_50_FLAGS       ((STAI_FLAG_PREALLOCATED))
#define STAI_NETWORK_WEIGHT_50_SIZE        (1024)
#define STAI_NETWORK_WEIGHT_50_SIZE_BYTES  (1024)
#define STAI_NETWORK_WEIGHT_51_FLAGS       ((STAI_FLAG_PREALLOCATED))
#define STAI_NETWORK_WEIGHT_51_SIZE        (2304)
#define STAI_NETWORK_WEIGHT_51_SIZE_BYTES  (2304)
#define STAI_NETWORK_WEIGHT_52_FLAGS       ((STAI_FLAG_PREALLOCATED))
#define STAI_NETWORK_WEIGHT_52_SIZE        (1024)
#define STAI_NETWORK_WEIGHT_52_SIZE_BYTES  (1024)
#define STAI_NETWORK_WEIGHT_53_FLAGS       ((STAI_FLAG_PREALLOCATED))
#define STAI_NETWORK_WEIGHT_53_SIZE        (65536)
#define STAI_NETWORK_WEIGHT_53_SIZE_BYTES  (65536)
...
#define STAI_NETWORK_WEIGHT_55_SIZE        (2560)
#define STAI_NETWORK_WEIGHT_55_SIZE_BYTES  (2560)
#define STAI_NETWORK_WEIGHT_56_FLAGS       ((STAI_FLAG_PREALLOCATED))
#define STAI_NETWORK_WEIGHT_56_SIZE        (40)
#define STAI_NETWORK_WEIGHT_56_SIZE_BYTES  (40)
