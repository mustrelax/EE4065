...
#define STAI_NETWORK_ORIGIN_MODEL_NAME         "audio_model"
#define STAI_NETWORK_ORIGIN_MODEL_SIGNATURE    "0x942cbb3b8b37dfb9f079ade75c401b2e"

/*  Generated model name and signature  */
#define STAI_NETWORK_MODEL_NAME                "network"
#define STAI_NETWORK_MODEL_SIGNATURE           (0x7ab5a7f616a011ff)
...
#define STAI_NETWORK_IN_1_SHAPE       {1,260}
#define STAI_NETWORK_IN_1_BATCH       (1)
#define STAI_NETWORK_IN_1_CHANNEL     (260)
#define STAI_NETWORK_IN_1_RANK        (1)
#define STAI_NETWORK_IN_1_SIZE        (260)
#define STAI_NETWORK_IN_1_SIZE_BYTES  (1040)
...
#define STAI_NETWORK_ACTIVATIONS_SIZE              (1296)
#define STAI_NETWORK_ACTIVATIONS_SIZE_BYTES        (1296)
...
#define STAI_NETWORK_ACTIVATION_1_SIZE       (1296)
#define STAI_NETWORK_ACTIVATION_1_SIZE_BYTES (1296)
...
#define STAI_NETWORK_WEIGHTS_SIZE                  (76456)
#define STAI_NETWORK_WEIGHTS_SIZE_BYTES            (76456)
#define STAI_NETWORK_WEIGHTS_ALIGNMENTS \
  { 4,4,4,4,4,4}
#define STAI_NETWORK_WEIGHTS_SIZES \
  { 66560,256,8192,128,1280,40}
#define STAI_NETWORK_WEIGHTS_NUM        (6)
#define STAI_NETWORK_WEIGHT_1_FLAGS       ((STAI_FLAG_PREALLOCATED))
#define STAI_NETWORK_WEIGHT_1_SIZE        (66560)
#define STAI_NETWORK_WEIGHT_1_SIZE_BYTES  (66560)
#define STAI_NETWORK_WEIGHT_2_FLAGS       ((STAI_FLAG_PREALLOCATED))
#define STAI_NETWORK_WEIGHT_2_SIZE        (256)
#define STAI_NETWORK_WEIGHT_2_SIZE_BYTES  (256)
#define STAI_NETWORK_WEIGHT_3_FLAGS       ((STAI_FLAG_PREALLOCATED))
#define STAI_NETWORK_WEIGHT_3_SIZE        (8192)
#define STAI_NETWORK_WEIGHT_3_SIZE_BYTES  (8192)
#define STAI_NETWORK_WEIGHT_4_FLAGS       ((STAI_FLAG_PREALLOCATED))
#define STAI_NETWORK_WEIGHT_4_SIZE        (128)
#define STAI_NETWORK_WEIGHT_4_SIZE_BYTES  (128)
#define STAI_NETWORK_WEIGHT_5_FLAGS       ((STAI_FLAG_PREALLOCATED))
#define STAI_NETWORK_WEIGHT_5_SIZE        (1280)
#define STAI_NETWORK_WEIGHT_5_SIZE_BYTES  (1280)
