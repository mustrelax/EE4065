...
/*****************************************************************************/
#define _STAI_NETWORK_MODEL_SIGNATURE     "0x942cbb3b8b37dfb9f079ade75c401b2e"
#define _STAI_NETWORK_DATETIME            "2025-12-24T17:55:23+0000"
...
static const stai_network_info g_network_info = {
  ...
  .inputs = (stai_tensor[STAI_NETWORK_IN_NUM]) {
    STAI_INIT_TENSOR(
      ...
      STAI_DECLARE_ARRAY(int32_t, 2, 1, 260),
      STAI_EMPTY_ARRAY(),
      STAI_EMPTY_ARRAY()),
    },
  ...
  .weights = (stai_tensor[STAI_NETWORK_WEIGHTS_NUM]) {
    STAI_INIT_TENSOR(
      ...
      STAI_DECLARE_ARRAY(int32_t, 1, 66560),
      STAI_EMPTY_ARRAY(),
      STAI_EMPTY_ARRAY()),
    STAI_INIT_TENSOR(
      (NULL),
  ...
  stai_network* network)
{
...

  {
    const _stai_network_context _network_context = {
      ...
      ._weights = {
      (stai_ptr)g_network_gemm_0_weights_array,(stai_ptr)g_network_gemm_0_bias_array,(stai_ptr)g_network_gemm_1_weights_array,(stai_ptr)g_network_gemm_1_bias_array,(stai_ptr)g_network_gemm_2_weights_array,(stai_ptr)g_network_gemm_2_bias_array
      },
      ._inputs = {
    NULL},
      ._outputs = {
...
static const ai_i32 nl_0_nl_t_in_0_shape_ch_prod_const_s32 = 64;


static const ai_i32 nl_1_nl_t_in_0_shape_ch_prod_const_s32 = 32;
