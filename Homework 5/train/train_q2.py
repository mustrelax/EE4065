...
# --- OUTPUT VALUES FOR STM32 ---
print("// Normalization Mean Values")
print("float features_mean[7] = {", end="")
print(", ".join(f"{x:.6f}f" for x in features_mean), end="};\n\n")

print("// Normalization Std Values")
print("float features_std[7] = {", end="")
print(", ".join(f"{x:.6f}f" for x in features_std), end="};\n")
print("="*40)
...
y_pred_probs = model.predict(test_huMoments)
